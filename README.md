...
HoopsHype and NBA had slight discrpencies in the spelling of players' names, so I cleaned the data by removing accent marks and ensuring generational suffixes matched. I also decided to treat all restricted free agents as if they are freely negotiating to see what their true market value is according to my model.
